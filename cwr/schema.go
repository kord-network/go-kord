...
CREATE TABLE publisher_control (
	...
	publisher_unknown_indicator       text NOT NULL,
	publisher_type                    text NOT NULL,
	tax_id_number                     text NOT NULL,
	publisher_ipi_name_number         text NOT NULL,
	pr_affiliation_society_number     text NOT NULL,
	submitter_agreement_number        text NOT NULL,
	...
	special_agreements_indicator      text NOT NULL,
	first_recording_refusal_ind       text NOT NULL,
	publisher_ipi_base_number         text NOT NULL,
	inter_standard_agreement_code     text NOT NULL,
	society_assigned_agreement_number text NOT NULL,
	agreement_type                    text NOT NULL,
	usa_license_ind                   text NOT NULL,
	record_type                       text NOT NULL
);
...
CREATE TABLE writer_control (
	...
	writer_unknown_indicator text NOT NULL,
	writer_designation_code  text NOT NULL,
	tax_id_number            text NOT NULL,
